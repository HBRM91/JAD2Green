...
-- Add short code to methodologies (referenced by migration 6 intensity_rse)
...
-- Backfill methodology.code for rows migration 6 looks up by code
UPDATE methodologies SET code = 'BILAN_CARBONE' WHERE id = '00000000-0000-0000-0000-000000000001' AND code IS NULL;
UPDATE methodologies SET code = 'ISO_14064'     WHERE id = '00000000-0000-0000-0000-000000000002' AND code IS NULL;
UPDATE methodologies SET code = 'GHG_PROTOCOL'   WHERE id = '00000000-0000-0000-0000-000000000003' AND code IS NULL;
UPDATE methodologies SET code = 'GRI_305'        WHERE id = '00000000-0000-0000-0000-000000000004' AND code IS NULL;
UPDATE methodologies SET code = 'AMEE'           WHERE id = '00000000-0000-0000-0000-000000000005' AND code IS NULL;
